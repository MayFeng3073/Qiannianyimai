// 三国数据导入脚本 v1：从 Excel 生成 frontend/public/data/dynasty_109.json
// 结构对齐 import-han.js（汉），只改朝代配置/ID前缀/类型映射/二级分类/别名
// 用法：node scripts/import-109.js
...
const DYN = {
  id: 109, name: '三国', english_name: 'Three Kingdoms',
  ...
  capital: '洛阳、成都、建业', population: '约数千万', duration: '约60年',
  representative_buildings: ['铜雀台', '成都城', '建业城'],
  characteristics: { politics: 82, culture: 88, military: 96, technology: 78, openness: 70 }
};

// ---- 读取并过滤三国数据 ----
const l1 = read('1级人物数据.xlsx').filter(r => String(col(r, '朝代')).includes('三国'));
const l2 = read('2级人物数据.xlsx').filter(r => String(col(r, '朝代')).includes('三国') || ['傅玄', '卫瓘'].includes(String(col(r, '姓名')).trim()));
const ev = read('事件数据.xlsx').filter(r => String(col(r, '朝代')).includes('三国'));
const kw = read('朝代热力图.xlsx').filter(r => String(col(r, '朝代')).includes('三国'));
...
const L2_CAT_MAP_SANGUO = {
  // —— 军事人物 ——
  '曹彰': '军事人物', '曹真': '军事人物', '曹休': '军事人物', '曹仁': '军事人物', '夏侯惇': '军事人物',
  '夏侯渊': '军事人物', '徐晃': '军事人物', '张郃': '军事人物', '于禁': '军事人物', '乐进': '军事人物',
  '李典': '军事人物', '典韦': '军事人物', '许褚': '军事人物', '满宠': '军事人物', '陈泰': '军事人物',
  '王昶': '军事人物', '毌丘俭': '军事人物', '文钦': '军事人物', '田豫': '军事人物', '牵招': '军事人物',
  '刘封': '军事人物', '陈到': '军事人物', '黄忠': '军事人物', '马超': '军事人物', '马岱': '军事人物',
  '廖化': '军事人物', '吴懿': '军事人物', '吴班': '军事人物', '向宠': '军事人物', '马谡': '军事人物',
  '关平': '军事人物', '关兴': '军事人物', '张苞': '军事人物', '霍峻': '军事人物', '高翔': '军事人物',
  '太史慈': '军事人物', '程普': '军事人物', '黄盖': '军事人物', '韩当': '军事人物', '周泰': '军事人物',
  '蒋钦': '军事人物', '丁奉': '军事人物', '凌统': '军事人物', '徐盛': '军事人物', '潘璋': '军事人物',
  '陈武': '军事人物', '朱然': '军事人物', '朱桓': '军事人物', '吕据': '军事人物', '孙韶': '军事人物',
  '孙桓': '军事人物', '孙皎': '军事人物', '吕岱': '军事人物', '邓忠': '军事人物', '诸葛尚': '军事人物',
  '杜预': '军事人物', '卫瓘': '军事人物', '糜芳': '军事人物', '全琮': '军事人物', '贺齐': '军事人物', '孟获': '军事人物',
  // —— 政治人物 ——
  '夏侯尚': '政治人物', '王凌': '政治人物', '贾逵': '政治人物', '辛毗': '政治人物', '辛评': '政治人物',
  '董昭': '政治人物', '荀彧': '政治人物', '郭嘉': '政治人物', '贾诩': '政治人物', '刘晔': '政治人物',
  '蒋济': '政治人物', '华歆': '政治人物', '王朗': '政治人物', '杨修': '政治人物', '崔琰': '政治人物',
  '徐庶': '政治人物', '司马师': '政治人物', '司马孚': '政治人物', '王经': '政治人物', '刘琦': '政治人物',
  '糜竺': '政治人物', '简雍': '政治人物', '孙乾': '政治人物', '伊籍': '政治人物', '李严': '政治人物',
  '杨仪': '政治人物', '陈震': '政治人物', '邓芝': '政治人物', '郭攸之': '政治人物', '马良': '政治人物',
  '费诗': '政治人物', '张纮': '政治人物', '顾雍': '政治人物', '步骘': '政治人物', '张温': '政治人物',
  '诸葛瑾': '政治人物', '陆凯': '政治人物', '吕范': '政治人物', '潘濬': '政治人物', '向朗': '政治人物',
  '来敏': '政治人物', '许靖': '政治人物', '张春华': '政治人物', '李恢': '政治人物', '孙鲁班': '政治人物', '孙鲁育': '政治人物',
  // —— 思想人物 ——
  '夏侯玄': '思想人物', '谯周': '思想人物', '庞德公': '思想人物', '虞翻': '思想人物', '秦宓': '思想人物',
  // —— 文化人物 ——
  '曹植': '文化人物', '陈琳': '文化人物', '王粲': '文化人物', '甄宓': '文化人物', '辛宪英': '文化人物',
  '杜夫人': '文化人物', '王元姬': '文化人物', '傅玄': '文化人物', '薛综': '文化人物',
  // —— 科技人物 ——
  '黄月英': '科技人物', '皇甫谧': '科技人物',
  // —— 统治者 ——
  '袁绍': '统治者', '袁术': '统治者', '孙登': '统治者', '曹冲': '统治者'
};
// 兜底默认分类（未被覆盖的二级人物）
...
for (const r of l2) {
  ...
  const summary = (storyTitle && storyTitle.length >= 3)
    ? `${name}是三国时期的历史人物，其重要事迹为「${storyTitle}」，从侧面展现了这一时期的历史风貌。`
    : `${name}是三国时期的历史人物，其事迹载于史籍文献，从侧面展现了这一时期的历史风貌。`;
  const cat = L2_CAT_MAP_SANGUO[name] || DEFAULT_L2_CAT;
  const p = {
    id, name, dynasty: (name === '傅玄' || name === '卫瓘') ? '晋南北朝' : '三国',
    summary,
...
for (const r of ev) {
  ...
  evNameToId[name] = id;
  const y = parseYear(String(col(r, '发生时间') || '')) || 220;
  const bg = {};
  ...
  const one_sentence = (osFirst && osFirst.length >= 8 && osFirst !== summaryText)
    ? osFirst
    : `「${name}」作为三国时期重要的${etype}事件，深刻影响了当时的政治格局，是理解三国历史的关键节点。`;
  events.push({
    id, name, dynasty: '三国',
...
const keywords = kw.map(r => ({ name: String(col(r, '关键词')), value: Number(col(r, '权重（100）')) || 50, category: KC[String(col(r, '类别'))] || 'era', desc: String(col(r, '关键词')) + '是三国时期的重要概念。' }));
...
const target = path.join(dir, 'frontend/public/data/dynasty_109.json');
fs.writeFileSync(target, JSON.stringify(out, null, 2), 'utf-8');

console.log('dynasty_109.json 生成完成');
...
if (fs.existsSync(path.join(__dirname, 'fix_109_content.js'))) {
  console.log('\n--- 运行内容精修 fix_109_content.js ---');
  require('./fix_109_content.js');
}
if (fs.existsSync(path.join(__dirname, 'enrich_109_relations.js'))) {
  console.log('\n--- 运行数据丰富 enrich_109_relations.js ---');
  require('./enrich_109_relations.js');
}
