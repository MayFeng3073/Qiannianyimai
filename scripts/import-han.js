// 汉数据导入脚本 v1：从 Excel 生成 frontend/public/data/dynasty_107.json
// 结构对齐 import-qin.js（秦），只改朝代配置/ID前缀/类型映射/二级分类/别名
// 用法：node scripts/import-han.js
...
const DYN = {
  id: 107, name: '汉', english_name: 'Han Dynasty',
  ...
  capital: '长安、洛阳', population: '约5700万', duration: '422年',
  representative_buildings: ['未央宫', '建章宫', '长城'],
  characteristics: { politics: 90, culture: 88, military: 95, technology: 82, openness: 85 }
};

// ---- 读取并过滤汉数据 ----
const l1 = read('1级人物数据.xlsx').filter(r => String(col(r, '朝代')).includes('汉'));
const l2 = read('2级人物数据.xlsx').filter(r => String(col(r, '朝代')).includes('汉'));
const ev = read('事件数据.xlsx').filter(r => String(col(r, '朝代')).includes('汉'));
const kw = read('朝代热力图.xlsx').filter(r => String(col(r, '朝代')).includes('汉'));
...
function parseYear(s) {
  ...
  const t = s.trim();
  let m = t.match(/约?公元前?(\d{1,4})(?:年|世纪)?/); // 前206年 / 公元前202年
  if (m) return t.includes('世纪') ? -parseInt(m[1]) * 100 : -parseInt(m[1]);
  m = t.match(/约?(\d{1,2})世纪(?:初|中叶|前期|后期|末)?/); // 1世纪中叶 -> AD
  if (m) return parseInt(m[1]) * 100;
  m = t.match(/^约?(\d{1,4})年?/); // 105年 / 9年 / 184年 等公元纪年
...
const L2_CAT_MAP_HAN = {
  // —— 军事人物 ——
  '樊哙': '军事人物', '夏侯婴': '军事人物', '郦商': '军事人物', '灌婴': '军事人物', '周勃': '军事人物',
  '彭越': '军事人物', '英布': '军事人物', '韩王信': '军事人物', '刘贾': '军事人物', '周苛': '军事人物',
  '纪信': '军事人物', '窦婴': '军事人物', '周亚夫': '军事人物', '李广': '军事人物', '程不识': '军事人物',
  '公孙贺': '军事人物', '金日磾': '军事人物', '李陵': '军事人物', '李广利': '军事人物', '公孙敖': '军事人物',
  '李息': '军事人物', '赵破奴': '军事人物', '苏建': '军事人物', '甘延寿': '军事人物', '陈汤': '军事人物',
  '王恢': '军事人物', '赵充国': '军事人物', '赤眉军樊崇': '军事人物', '吴汉': '军事人物', '冯异': '军事人物',
  '耿弇': '军事人物', '寇恂': '军事人物', '岑彭': '军事人物', '贾复': '军事人物', '祭遵': '军事人物',
  '马成': '军事人物', '铫期': '军事人物', '邓晨': '军事人物', '马援': '军事人物', '窦宪': '军事人物',
  '隗嚣': '军事人物', '董卓': '军事人物', '邓禹': '军事人物', '公孙述': '军事人物', '项羽': '军事人物',
  // —— 政治人物 ——
  '郦食其': '政治人物', '吴芮': '政治人物', '张耳': '政治人物', '陈馀': '政治人物', '卢绾': '政治人物',
  '王陵': '政治人物', '刘敬': '政治人物', '魏无知': '政治人物', '随何': '政治人物', '袁盎': '政治人物',
  '申屠嘉': '政治人物', '邓通': '政治人物', '田蚡': '政治人物', '冯唐': '政治人物', '韩安国': '政治人物',
  '汲黯': '政治人物', '卜式': '政治人物', '公孙弘': '政治人物', '张汤': '政治人物', '桑弘羊': '政治人物',
  '主父偃': '政治人物', '赵禹': '政治人物', '儿宽': '政治人物', '田千秋': '政治人物', '江充': '政治人物',
  '朱买臣': '政治人物', '严助': '政治人物', '苏武': '政治人物', '常惠': '政治人物', '傅介子': '政治人物',
  '郑吉': '政治人物', '唐蒙': '政治人物', '上官桀': '政治人物', '霍禹': '政治人物', '霍显': '政治人物',
  '丙吉': '政治人物', '魏相': '政治人物', '黄霸': '政治人物', '石显': '政治人物', '王凤': '政治人物',
  '王音': '政治人物', '王根': '政治人物', '何武': '政治人物', '翟义': '政治人物', '李通': '政治人物',
  '邓骘': '政治人物', '梁冀': '政治人物', '窦武': '政治人物', '李膺': '政治人物', '陈蕃': '政治人物',
  '李固': '政治人物', '曹参': '政治人物', '萧望之': '政治人物', '伏湛': '政治人物',
  // —— 思想人物 ——
  '叔孙通': '思想人物', '陆贾': '思想人物', '贾山': '思想人物', '杨震': '思想人物', '张角': '思想人物',
  // —— 文化人物 ——
  '刘交': '文化人物', '李延年': '文化人物', '刘向': '文化人物', '刘歆': '文化人物', '班昭': '文化人物',
  '东方朔': '文化人物', '司马相如': '文化人物',
  // —— 科技人物 ——
  '张衡': '科技人物', // L1 已有，此处占位防止漏
  // —— 统治者 ——
  '窦太后': '统治者', '上官皇后': '统治者', '王政君': '统治者', '刘玄': '统治者', '刘盆子': '统治者',
  '阴丽华': '统治者', '郭圣通': '统治者', '邓太后': '统治者', '梁太后': '统治者', '卫子夫': '统治者',
  '明德马皇后': '统治者', '冒顿单于': '统治者', '曹丕': '统治者', '王昭君': '统治者'
};
// 兜底默认分类（未被覆盖的二级人物）
...
for (const r of l2) {
  const name = String(col(r, '姓名'));
  if (nameToId[name]) continue; // 与一级重名则跳过（如 司马相如）
  const id = 107100 + i2++;
  nameToId[name] = id;
  addAlias(name, name);
  ...
  const summary = (storyTitle && storyTitle.length >= 3)
    ? `${name}是汉时期的历史人物，其重要事迹为「${storyTitle}」，从侧面展现了这一时期的历史风貌。`
    : `${name}是汉时期的历史人物，其事迹载于史籍文献，从侧面展现了这一时期的历史风貌。`;
  const cat = L2_CAT_MAP_HAN[name] || DEFAULT_L2_CAT;
  const p = {
    id, name, dynasty: '汉',
    summary,
...
let e1 = 1;
const evNameToId = {};
const TYPE_MAP = { '战争军事': '战争军事', '政治制度': '政治事件', '政治': '政治事件', '外交交流': '外交', '外交': '外交', '对外交流': '外交', '经济贸易': '经济', '经济': '经济', '思想教育': '思想文化', '思想文化': '思想文化', '文化艺术': '文化艺术', '文化': '文化艺术', '科技发明': '科技发明', '科技': '科技发明' };
for (const r of ev) {
  const id = 107300 + e1++;
  const name = String(col(r, '事件名称'));
  evNameToId[name] = id;
  const y = parseYear(String(col(r, '发生时间') || '')) || -200;
  const bg = {};
  ...
  const one_sentence = (osFirst && osFirst.length >= 8 && osFirst !== summaryText)
    ? osFirst
    : `「${name}」作为汉时期重要的${etype}事件，深刻影响了当时的政治格局，是理解汉代历史的关键节点。`;
  events.push({
    id, name, dynasty: '汉',
...
// ---- 关键词 ----
const KC = { '时代印象': 'era', '历史概念': 'event', '政治改革': 'civilization', '历史事件': 'event', '政治理念': 'civilization', '外交制度': 'civilization', '人物': 'person', '人物故事': 'person', '历史典故': 'event', '思想文化': 'civilization', '政治格局': 'era', '战争': 'event', '制度文化': 'civilization', '科技发明': 'civilization' };
const keywords = kw.map(r => ({ name: String(col(r, '关键词')), value: Number(col(r, '权重（100）')) || 50, category: KC[String(col(r, '类别'))] || 'era', desc: String(col(r, '关键词')) + '是汉时期的重要概念。' }));
require('./kw_patch.js').injectKeywords(keywords, DYN.name);
...
const target = path.join(dir, 'frontend/public/data/dynasty_107.json');
fs.writeFileSync(target, JSON.stringify(out, null, 2), 'utf-8');

console.log('dynasty_107.json 生成完成');
...
console.log('\n--- 运行内容精修 fix_107_content.js ---');
require('./fix_107_content.js');
console.log('\n--- 运行数据丰富 enrich_107_relations.js ---');
require('./enrich_107_relations.js');